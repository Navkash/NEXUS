...
import com.nexus.navkashkrishna.nexusdemo.QueryActivity;
...
public class TitleCreater {
    ...
    public TitleCreater(Context context) {
        ...
        for(int i = 0; i< QueryActivity.data.size(); i++)
        {
            _titleParents.add(new TitleParent(QueryActivity.data.get(i).getQuestion()));
